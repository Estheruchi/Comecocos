...
**Importante --> Dejar que el movimeinto de la ficha termine para volver a lanzar el dado.
...
** pero el programa funcionaba de manera correcta porque la ficha se comenzaba a desplazar donde debía.
**
 */
package comecocos;
